...
function LoginContent() {
    ...
    return (
        <div
            className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 p-4">
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="flex justify-center">
                        {GOOGLE_CLIENT_ID ? (
                            ...
                            <div
                                className="rounded-lg border border-destructive bg-destructive/10 p-4 text-center text-sm text-destructive">
